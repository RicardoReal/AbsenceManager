...
namespace AbsenceManager.DynamicData.CustomPages.TrackFeriasFuncionarios
{
    public partial class List : System.Web.UI.Page
    {
        protected MetaTable table;
        string _feriasFuncsID;
        ...
        {
            _feriasFuncsID = Request.Params.Get("ID");
        ...
        {
            if (!String.IsNullOrEmpty(_feriasFuncsID))
            {
                e.Query = SearchHelpers.GetTrackChangesFilter(e.Query, _feriasFuncsID, "FeriasFuncionarioID");
            }
        }
    }
}
