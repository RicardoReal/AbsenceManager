...
namespace AbsenceManager.DynamicData.CustomPages.TrackHorasFuncionarios
{
    public partial class List : System.Web.UI.Page
    {
        ...
        {
            _horasFuncsID = Request.Params.Get("ID");
        ...
        {
            if (!String.IsNullOrEmpty(_horasFuncsID))
            {
                e.Query = SearchHelpers.GetTrackChangesFilter(e.Query, _horasFuncsID, "HorasFuncionarioID");
            }
        }
    }
}
