<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="List.aspx.cs" Inherits="AbsenceManager.DynamicData.CustomPages.FeriasFuncionarios.List" %>
        ...
        <ContentTemplate>
            ...
            <div id="GridViewContainer">
                <asp:GridView ID="GridView1" runat="server" DataSourceID="GridDataSource" EnablePersistedSelection="true"
                    ...
                    OnRowCreated="GridView1_RowCreated" OnRowCommand="GridView1_ItemCommand" OnRowDataBound="GridView1_RowDataBound">
                    <PagerTemplate>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Button ID="ButtonAprov" runat="server" CommandName="Aprov" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                    Text="Aprovar" CssClass="StatusButtonAprov" Width="100px" />
                                <%--<div id="BtnDiv" runat="server" style="margin-left: 210px; display: inline;">
                                </div>--%>
                                <asp:Button ID="ButtonNaoAprov" runat="server" CommandName="NaoAprov" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                    Text="Não Aprovar" CssClass="StatusButtonNaoAprov" Width="100px"  />
                            </ItemTemplate>
                        </asp:TemplateField>
