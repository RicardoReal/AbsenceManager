<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="List.aspx.cs" Inherits="AbsenceManager.DynamicData.CustomPages.TrackAusenciaFuncionarios.List" %>
        ...
        <ContentTemplate>
            ...
            <div id="GridViewContainer">
                <asp:GridView ID="GridView1" runat="server" DataSourceID="GridDataSource" EnablePersistedSelection="true"
                    ...
                    <Columns>
                        <asp:TemplateField ShowHeader="False" ItemStyle-CssClass="EditColumn">
                            <ItemTemplate>
                                <asp:DynamicHyperLink ID="DynamicHyperLinkEdit" runat="server" Action="Edit">
                ...
                <asp:EntityDataSource ID="GridDataSource" runat="server" EnableDelete="true" EnableUpdate="true"
                    OnSelecting="GridDataSource_Selecting" OrderBy="it.ChangedDateTime DESC"/>
                <asp:QueryExtender TargetControlID="GridDataSource" ID="GridQueryExtender" runat="server">
                    <asp:DynamicFilterExpression ControlID="FilterRepeater" />
                    <asp:SearchExpression DataFields="default" SearchType="Contains">
                        <asp:ControlParameter ControlID="TextBoxSearch" />
                    </asp:SearchExpression>
                    <asp:CustomExpression OnQuerying="SetCustomFilters">
