...
{
    public partial class DateGreaterThanFilter : System.Web.DynamicData.QueryableFilterUserControl
    {
        ...
        private Expression BuildQueryBody(ParameterExpression parameterExpression)
        {
            ...
            return BuildCompareExpression(parameterExpression, propertyExpression, converter.ConvertFromString(DateFrom), Expression.GreaterThanOrEqual);
        }
