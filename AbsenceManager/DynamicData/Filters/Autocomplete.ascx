<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Autocomplete.ascx.cs"
    Inherits="AbsenceManager.Autocomplete_Filter" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<asp:TextBox runat="server" ID="AutocompleteTextBox" Width="300px" autocomplete="off"
    CssClass="DDFilter Autocomplete" OnTextChanged="AutocompleteTextBox_TextChanged" />
