...
{
    public partial class HorasFuncionarios_EditEntityTemplate : System.Web.DynamicData.EntityTemplateUserControl
    {
        ...
        private string[] readOnlyFields = new string[] { "NrPresencas" };
        ...
        protected void DynamicControl_Init(object sender, EventArgs e)
        {
            ...
            if (readOnlyFields.Contains(currentColumn.Name))
