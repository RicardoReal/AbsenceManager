<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="List.aspx.cs" Inherits="AbsenceManager.List" %>
                    ...
                    <Columns>
                        <asp:TemplateField ShowHeader="False" ItemStyle-CssClass="EditColumn">
                            <ItemTemplate>
                                ...
                                <asp:ImageButton ImageUrl="~/Images/inline_edit.png" ID="ImageButtonInlineEdit" runat="server" Visible='<%# HasOnScreenPermission %>'
