<%@ Control Language="C#" CodeBehind="GridViewUsers_Edit.ascx.cs" Inherits="AbsenceManager.GridViewUsers_Edit" %>
...
<asp:EntityDataSource ID="FormViewDataSource" runat="server" EnableDelete="true"
    EnableFlattening="true" OnInserted="FormViewDataSource_Inserted" />
