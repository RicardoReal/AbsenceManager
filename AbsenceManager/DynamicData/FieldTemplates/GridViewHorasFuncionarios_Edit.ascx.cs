...
{
    public partial class GridViewHorasFuncionarios_Edit : FieldTemplateUserControl
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (metaChildColumn != null && metaForeignKeyColumn != null)
            {
                ...
                {
                    // TIPO HORAS - NORMAIS
                    tipoHorasId = ent.TipoHoras.Where(t => t.Descricao.Contains("Normais")).FirstOrDefault().ID;
                    dict.Add("TipoHorasID", tipoHorasId);
        ...
        protected void FormViewDataSource_Inserting(object sender, EntityDataSourceChangingEventArgs e)
        {
            ...
            using (AM_Entities ent = new AM_Entities())
            {
                DateTime data = ent.HorasFuncionarios.Where(x => x.ID == Id).FirstOrDefault().Data;
                
                FuncionarioHorasFuncionario fhf = e.Entity as FuncionarioHorasFuncionario;
